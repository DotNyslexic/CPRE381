...
entity tb_MIPSInstructionDecoderPartTwo is

end tb_MIPSInstructionDecoderPartTwo;

architecture behavior of tb_MIPSInstructionDecoderPartTwo is

component MIPSInstructionDecoderPartTwo
...
signal s_reg_Jump, s_Branch, s_Mem_Write, s_ALU_Src, s_Reg_Write, s_LUI, s_Sign_Extend_Choice, s_ALUn_AddSub, s_Shifter_Mux_Control, s_Arithmetic, s_Sign_Extended, s_Left_Shift, s_Variable_Shift : std_logic;
signal s_ALU_Op : std_logic_vector(2 downto 0);
signal s_isBranch, s_isBNE, s_isJump, s_isJR : std_logic;
signal s_reg_Dst, s_Mem_To_Reg : std_logic_vector(1 downto 0);

begin

DUT: MIPSInstructionDecoderPartTwo
...
-- BNE
s_instruction_function <= "000000";
s_instruction_opcode <= "000101";

wait for 100 ns;

-- JUMP
s_instruction_function <= "000000";
s_instruction_opcode <= "000010";

wait for 100 ns;

-- JAL
s_instruction_function <= "000000";
s_instruction_opcode <= "000011";

wait for 100 ns;

-- JR
s_instruction_function <= "001000";
s_instruction_opcode <= "000000";
